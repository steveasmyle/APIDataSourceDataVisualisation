...
import './styles.css'
import dataFeed from './assets/json/datafeed.json'
...
function Jumbo() {
  ...
  return (
    <group ref={ref}>
      <Text hAlign="right" position={[-12, 6.5, 0]} children={dataFeed.total} />
      <Text hAlign="right" position={[-12, 0, 0]} children={dataFeed.topbids[0].name} />
      <Text hAlign="right" position={[-12, -6.5, 0]} children={dataFeed.latestbids[0].name} />
    </group>
  )
}
